...
export class Contract {
        ...
        this.circuits = {
            register_agent: (...args_1) => {
                ...
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('register_agent', 'argument 1 (as invoked from Typescript)', 'BlindSwarm.compact line 48 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(capabilities_0.buffer instanceof ArrayBuffer && capabilities_0.BYTES_PER_ELEMENT === 1 && capabilities_0.length === 64)) {
                    __compactRuntime.typeError('register_agent', 'argument 1 (argument 2 as invoked from Typescript)', 'BlindSwarm.compact line 48 char 1', 'Bytes<64>', capabilities_0);
                }
                if (!(typeof (stake_0) === 'bigint' && stake_0 >= 0n && stake_0 <= 18446744073709551615n)) {
                    __compactRuntime.typeError('register_agent', 'argument 2 (argument 3 as invoked from Typescript)', 'BlindSwarm.compact line 48 char 1', 'Uint<0..18446744073709551616>', stake_0);
                }
                ...
                const result_0 = this._register_agent_0(context, partialProofData, capabilities_0, stake_0);
            ...
            create_task: (...args_1) => {
                ...
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('create_task', 'argument 1 (as invoked from Typescript)', 'BlindSwarm.compact line 58 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(task_id_0.buffer instanceof ArrayBuffer && task_id_0.BYTES_PER_ELEMENT === 1 && task_id_0.length === 16)) {
                    __compactRuntime.typeError('create_task', 'argument 1 (argument 2 as invoked from Typescript)', 'BlindSwarm.compact line 58 char 1', 'Bytes<16>', task_id_0);
                }
                if (!(typeof (escrow_0) === 'bigint' && escrow_0 >= 0n && escrow_0 <= 18446744073709551615n)) {
                    __compactRuntime.typeError('create_task', 'argument 2 (argument 3 as invoked from Typescript)', 'BlindSwarm.compact line 58 char 1', 'Uint<0..18446744073709551616>', escrow_0);
                }
                if (!(typeof (deadline_0) === 'bigint' && deadline_0 >= 0n && deadline_0 <= 18446744073709551615n)) {
                    __compactRuntime.typeError('create_task', 'argument 3 (argument 4 as invoked from Typescript)', 'BlindSwarm.compact line 58 char 1', 'Uint<0..18446744073709551616>', deadline_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: {
                ...
                const result_0 = this._create_task_0(context, partialProofData, task_id_0, escrow_0, deadline_0);
                partialProofData.output = { value: [], alignment: [] };
                return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
            },
            submit_attestation: (...args_1) => {
                ...
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('submit_attestation', 'argument 1 (as invoked from Typescript)', 'BlindSwarm.compact line 68 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(task_id_0.buffer instanceof ArrayBuffer && task_id_0.BYTES_PER_ELEMENT === 1 && task_id_0.length === 16)) {
                    __compactRuntime.typeError('submit_attestation', 'argument 1 (argument 2 as invoked from Typescript)', 'BlindSwarm.compact line 68 char 1', 'Bytes<16>', task_id_0);
                }
                if (!(step_bytes_0.buffer instanceof ArrayBuffer && step_bytes_0.BYTES_PER_ELEMENT === 1 && step_bytes_0.length === 16)) {
                    __compactRuntime.typeError('submit_attestation', 'argument 2 (argument 3 as invoked from Typescript)', 'BlindSwarm.compact line 68 char 1', 'Bytes<16>', step_bytes_0);
                }
                if (!(output_hash_0.buffer instanceof ArrayBuffer && output_hash_0.BYTES_PER_ELEMENT === 1 && output_hash_0.length === 32)) {
                    __compactRuntime.typeError('submit_attestation', 'argument 3 (argument 4 as invoked from Typescript)', 'BlindSwarm.compact line 68 char 1', 'Bytes<32>', output_hash_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: {
                ...
                const result_0 = this._submit_attestation_0(context, partialProofData, task_id_0, step_bytes_0, output_hash_0);
                partialProofData.output = { value: [], alignment: [] };
                return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
            }
        };
    ...
    _secretKey_0(context, partialProofData) {
        ...
        if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
            __compactRuntime.typeError('secretKey', 'return value', 'BlindSwarm.compact line 31 char 1', 'Bytes<32>', result_0);
        }
    ...
    _submit_attestation_0(context, partialProofData, task_id_0, step_bytes_0, output_hash_0) {
        const sender_0 = this._callerPk_0(context, partialProofData);
    ...
    return {
        agents: {
            ...
            member(...args_0) {
                ...
                if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
                    __compactRuntime.typeError('member', 'argument 1', 'BlindSwarm.compact line 26 char 1', 'Bytes<32>', key_0);
                }
                return _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
            ...
            lookup(...args_0) {
                ...
                const key_0 = args_0[0];
                if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
                    __compactRuntime.typeError('lookup', 'argument 1', 'BlindSwarm.compact line 26 char 1', 'Bytes<32>', key_0);
                }
        ...
        tasks: {
            ...
            member(...args_0) {
                ...
                if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 16)) {
                    __compactRuntime.typeError('member', 'argument 1', 'BlindSwarm.compact line 27 char 1', 'Bytes<16>', key_0);
                }
                return _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
            ...
            lookup(...args_0) {
                ...
                const key_0 = args_0[0];
                if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 16)) {
                    __compactRuntime.typeError('lookup', 'argument 1', 'BlindSwarm.compact line 27 char 1', 'Bytes<16>', key_0);
                }
        ...
        attestations: {
            ...
            member(...args_0) {
                ...
                const key_0 = args_0[0];
                if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
                    __compactRuntime.typeError('member', 'argument 1', 'BlindSwarm.compact line 28 char 1', 'Bytes<32>', key_0);
                }
                return _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
            ...
            lookup(...args_0) {
                ...
                const key_0 = args_0[0];
                if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
                    __compactRuntime.typeError('lookup', 'argument 1', 'BlindSwarm.compact line 28 char 1', 'Bytes<32>', key_0);
                }
