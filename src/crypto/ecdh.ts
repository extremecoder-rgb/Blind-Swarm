...
export function encryptWithKey(senderPrivateKey: Buffer, recipientPublicKey: Buffer, plaintext: string): Buffer {
...
export function decryptWithKey(recipientPrivateKey: Buffer, senderPublicKey: Buffer, ciphertext: Buffer): string {
